...
%legLen1 is for once they are assembled, so twice a single leg:%Put clathrin-clathrin binding sites at 1/2 of the leg.
function[RigidCrds]=clath_crds(angle1, legLen1, legLen2)
format long
