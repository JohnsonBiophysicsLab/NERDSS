...
for itrDirectory in range(1,6):
    print("/Users/sikao/Downloads/Simulations/0911/pair/data/%d/histogram_complexes_time.dat" % (itrDirectory))
    ...
    f = open("/Users/sikao/Downloads/Simulations/0911/pair/data/%d/histogram_complexes_time.dat" % (itrDirectory))
    line = f.readline()
    if line[0] == 'i': # this is a iter line
    ...
    while line:
        ...
        if len(line) == 0:
            continue
        if line[0] == 'i': # this is a new iter line, append tempLine to output first
    ...
    np.savetxt("/Users/sikao/Downloads/Simulations/0911/pair/data/%d/sim_time.dat" % (itrDirectory), tmpResult[:,0] * timeStep / 1e6)
    np.savetxt("/Users/sikao/Downloads/Simulations/0911/pair/data/%d/sim_clatMem.dat" % (itrDirectory), tmpResult[:,1])
    np.savetxt("/Users/sikao/Downloads/Simulations/0911/pair/data/%d/sim_clatSol.dat" % (itrDirectory), tmpResult[:,2])
